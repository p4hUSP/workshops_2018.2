...
knitr::include_graphics('https://github.com/p4hUSP/workshops_2018.2/blob/master/imgs/w1_01.png')
```
...
```{r, echo = FALSE, fig.align='center', fig.height=5.0, fig.width=7.0}
knitr::include_graphics("https://github.com/p4hUSP/workshops_2018.2/blob/master/imgs/tidy-1.pngg")
```
